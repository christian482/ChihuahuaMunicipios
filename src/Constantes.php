...
class Constantes {
  ...
  const MENSAJE_SOY_JUBILADO_IMSS = "Perfecto, por ser Jubilado IMSS tiene derecho a su crédito personalizado y sin comisiones iniciales.";
  const MENSAJE_SOY_PENSIONADO_IMSS = "Perfecto, por ser Pensionado IMSS tiene derecho a su crédito personalizado y sin comisiones iniciales.";
  const MENSAJE_SOY_NINGUNO = "Otorgamos créditos a otros sectores federales";
  ...
  const MENSAJE_DESPEDIDA = "Perfecto. En un momento un asesor se pondrá en contacto con usted";
  const EXPLICAR_SERVICIO ="Credifintech se enfoca en apoyar a todos los Jubilados y Pensionados del IMSS con un gran beneficio que por ley tienen derecho y muchos no conocen.";
}
